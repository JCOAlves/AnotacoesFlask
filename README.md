...
## Sumario
1. [Criando um projeto Flask]("AnotacoesFlask/ProjetoFlask.md")
2. [Rotas na aplicação Flask]("AnotacoesFlask/CriandoRotas.md")
3. [Renderizando Templates (HTML)]("AnotacoesFlask/RenderizandoTemplates.md")
4. [Lidando com Arquivos Estáticos]("AnotacoesFlask/ArquivosEstaticos.md")
5. [Lidando com a sessão (`session`)]("AnotacoesFlask/Sessao.md")
6. [Implementado banco de dados SQL]("AnotacoesFlask/ConexaoBD.md")
7. [Manipulando banco de dados com o Flask]("AnotacoesFlask/ManipulacaoBD.md")
